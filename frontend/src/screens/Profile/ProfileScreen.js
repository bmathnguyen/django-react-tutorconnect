...
//           {userProfile.userType === 'student' ? 'Học sinh' : 'Gia sư'}
//         </Text>
//       </View>
...
//               <Text style={styles.infoText}>Điện thoại: {userProfile.phone}</Text>
//             </View>
//             <View style={styles.infoRow}>
//               <Icon name="school" size={20} color="#6b7280" />
//               <Text style={styles.infoText}>Trường: {userProfile.school}</Text>
//             </View>
//             {userProfile.userType === 'student' && (
//               <View style={styles.infoRow}>
//                 <Icon name="class" size={20} color="#6b7280" />
//                 <Text style={styles.infoText}>Lớp: {userProfile.grade}</Text>
//               </View>
//             )}
//           </View>
//         </View>
...
//             <Icon name="help" size={20} color="#374151" />
