...
# SECRET_KEY = "django-insecure-0mg(6o^&4g$jrmw4wmb@jnei1%=vko5!t@+ha1%25ano88_ia@"
...
# INSTALLED_APPS = [
#     'daphne',  # ← NEW: WebSocket support (must be first)
...
#     # Third party apps
#     'rest_framework',
#     # NEW means might not needed for now
#     'rest_framework_simplejwt',  # ← NEW: JWT authentication
#     'corsheaders',               # ← NEW: CORS for React Native
#     'django_filters',            # ← NEW: API filtering
#     'channels',                  # ← NEW: WebSocket channels
#     'channels_redis',            # ← NEW: Redis for WebSocket
    
#     # Local apps
#     'database',  # ← NEW: Added explicitly
#     'api',
# ]
...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = os.environ.get('SECRET_KEY', "django-insecure-0mg(6o^&4g$jrmw4wmb@jnei1%=vko5!t@+ha1%25ano88_ia@")  # NEW: Environment variable support
